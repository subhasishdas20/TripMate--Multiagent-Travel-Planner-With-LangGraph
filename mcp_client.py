...
client = MultiServerMCPClient(
    {
        ...
        "weather": {
            ...
            "command": r"E:\TripMate--Multiagent-Travel-Planner-With-LangGraph\.venv\Scripts\python.exe",

            # Uses the weather server inside the current project folder.
            "args": [
                r"E:\TripMate--Multiagent-Travel-Planner-With-LangGraph\weather_mcp_serv.py",
            ],
